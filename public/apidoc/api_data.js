	...
	api: [
		{
			...
			version: '1.0.0',
			description:
				'<p>This route will create all entities information on the system.</p>',
			permission: [
				{
					name: 'Admin',
				},
		...
		},
		{
			...
			version: '1.0.0',
			description:
				'<p>This is the Description. It is multiline capable.</p> <p>Last line of Description.</p>',
			permission: [
				{
					name: 'none',
				},
				...
				fields: {
					Parameter: [
						...
						},
						{
							...
							defaultValue: 'DE',
							description:
								'<p>Mandatory with default value &quot;DE&quot;.</p>',
						},
						{
							group: 'Parameter',
							type: 'Number',
					...
					Login: [
						{
							...
							field: 'pass',
							description:
								'<p>Only logged in users can post this. In generated documentation a separate &quot;Login&quot; Block will be generated.</p>',
						},
					],
				},
				examples: [
		...
		},
		{
			...
			group: 'Auth',
			version: '1.0.0',
			description: '<p>This route is used to refresh the actual token</p>',
			permission: [
				{
					name: 'none',
				},
					...
					Parameter: [
						{
							...
							field: 'token',
							description:
								'<p>This token will be used to validate and send the new token.</p>',
						},
					],
				},
				examples: [
		...
		},
		{
			...
			version: '1.0.0',
			description:
				'<p>This route is used to validate and active your email.</p>',
			permission: [
				{
					name: 'none',
				},
					...
					Parameter: [
						{
							...
							field: 'token',
							description:
								'<p>This token is send it by the application to your email.</p>',
						},
					],
				},
				examples: [
		...
		},
		{
			...
			version: '1.0.0',
			description:
				'<p>This route is used to reset password and set the new password</p>',
			permission: [
				{
					name: 'none',
				},
				...
				fields: {
					Parameter: [
						...
						},
						{
							...
							field: 'token',
							description:
								'<p>This token will be used to validate the system.</p>',
						},
					],
				},
				examples: [
		...
		},
		{
			...
			version: '1.0.0',
			description:
				'<p>This route is used to request a reset password for a specific email.</p>',
			permission: [
				{
					name: 'none',
				},
		...
		},
		{
			...
			group: 'Users',
			version: '1.0.0',
			description: '<p>This route is use to add a new role to the user</p>',
			permission: [
				{
					name: 'none',
				},
		...
		},
		{
			...
			group: 'Users',
			version: '1.0.0',
			description: '<p>This route is use to remove a role from the user</p>',
			permission: [
				{
					name: 'none',
				},
		...
		},
		{
			...
			version: '1.0.0',
			description:
				'<p>This route is use for get the current user inside the token.</p>',
			permission: [
				{
					name: 'none',
				},
